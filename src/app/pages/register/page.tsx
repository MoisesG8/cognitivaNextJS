        ...
        <div className={styles.container}>
            <div className={styles.loginBox}>
                ...
                <div className={styles.inputGroup}>
                    ...
                    <input type="edad" id="edad" name="edad" required  value={formData.edad} onChange={handleChange}/>
                </div>
                <div className={styles.inputGroup}>
                    <label htmlFor="correo">Correo Electrónico</label>
                    <input type="correo" id="correo" name="correo" required  value={formData.correo} onChange={handleChange}/>
                </div>
                <div className={styles.inputGroup}>
